...
# Colors mapped from the provided palette to reflect UI roles

bg_default = "#161616"          # main shade darkest (colors.primary.background)
bg_lighter = "#27292D"          # normal.black for slightly lighter backgrounds
bg_selection = "#4B4B4B"        # bright.black for selections
fg_disabled = "#BDBDBD"         # normal.white for disabled text
fg_default = "#C5C8C6"          # colors.primary.foreground
bg_lightest = "#E5E5E5"         # bright.white for lightest accents
fg_error = "#D44C6D"            # normal.red for errors
bg_hint = "#D0E460"             # normal.yellow for hints
fg_matched_text = "#30BA6F"     # normal.green for matched text
bg_passthrough_mode = "#01D6D4" # normal.cyan for passthrough mode
bg_insert_mode = "#7D57F8"      # normal.blue for insert mode
bg_warning = "#EB60D5"          # normal.magenta for warnings
...
# Foreground color of pinned selected even tubs.
